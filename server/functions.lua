...
function ClearInventory(source, filterItems)
    ...
    if not player.Offline then
        ...
        if Player(source).state.inv_busy then TriggerClientEvent('srm-inventory:client:updateInventory', source) end
    end
end
...
-- Finally, it triggers the 'srm-inventory:client:closeInv' event for the given source.
function CloseInventory(source, identifier)
    ...
    TriggerClientEvent('srm-inventory:client:closeInv', source)
end
...
function OpenInventoryById(source, targetId)
    ...
    TriggerClientEvent('srm-inventory:client:openInventory', source, playerItems, formattedInventory)
end
...
function OpenInventory(source, identifier, data)
    ...
    if not identifier then
        ...
        TriggerClientEvent('srm-inventory:client:openInventory', source, QBPlayer.PlayerData.items)
        return
    end
    ...
    TriggerClientEvent('srm-inventory:client:openInventory', source, QBPlayer.PlayerData.items, formattedInventory)
end
...
function AddItem(identifier, item, amount, slot, info, reason)
    ...
    local resourceName = GetInvokingResource() or 'srm-inventory'
    TriggerEvent(
